...
// =========================================================
export const TASA_DOLAR_VES = 318.00; // Tasa de cambio de USD a Bolívares
// =========================================================

// Precios base en USD para Roblox - NO CAMBIAR ESTOS VALORES
const robloxPackagesUSD = [
    { id: 1, name: '80 Robux', priceUSD: 1.80 },
    { id: 1, name: '400 Robux', priceUSD: 6.40 },
    { id: 2, name: '800 Robux', priceUSD: 10.20 },
...
const freefirePackagesUSD = [
    { id: 1, name: '100+10 Diamantes', priceUSD: 0.97 },
    { id: 2, name: '310+31 Diamantes', priceUSD: 3.00 },
    { id: 3, name: '520+52 Diamantes', priceUSD: 4.49 },
    { id: 4, name: '1050+105 Diamantes', priceUSD: 8.58 },
    { id: 5, name: '2180+218 Diamantes', priceUSD: 16.17 },
    { id: 6, name: '5600+560 Diamantes', priceUSD: 41.40 },
    { id: 7, name: 'Tarjeta Semanal', priceUSD: 2.18 },
    { id: 8, name: 'Tarjeta Mensual', priceUSD: 8.28 },
    { id: 9, name: 'Tarjeta Básica', priceUSD: 0.77},
    { id: 10, name: 'Pase de Nivel', priceUSD: 5.83 },
{ id: 11, name: 'Pase Booyah', priceUSD: 2.12}
];
